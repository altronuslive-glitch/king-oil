...
Иконки — компонент `Header btn` (`2099:58391`), 52×52 на десктопе, 48×48 на мобайле, иконка внутри 24 (`Icon size/icon-normal`).

Корзина окрашена в `--ko-icon-brand` **только когда в ней что-то есть** — это вариант
`Add=Yes` (`2099:58392`). Пустая корзина серая, как остальные иконки (`2099:58390`,
`Icon Color/icon-2`). Бейдж-счётчик — бокс 16×22 в правом верхнем углу кнопки, текст
Inter Medium 15/22. Поправлено 10 сентября, см. [26-logic-pass.md](26-logic-pass.md).
