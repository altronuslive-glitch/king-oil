...
Слева — колонка разделов (шириной ~300), выделенный пункт подсвечен `--ko-bg-1`. Справа — заголовок раздела H3 и подразделы в 3 колонки. Фон страницы за меню затемняется. Крестик закрытия — в правом верхнем углу над затемнением.
